...
describe("test server", () => {
  ...
  describe("ice cream flavors", () => {
    test.skip("responds with status 200 the GET method", () => {
    ...
    test.skip("response has expected number of ice cream flavors, and each has a name and image", () => {
      return request(server)
        .get("/scoops")
        .then((response) => {
  ...
  describe("toppings", () => {
    ...
    test.skip("response has expected number of ice cream toppings, and each has a name and image", () => {
      return request(server)
        .get("/toppings")
        .then((response) => {
  ...
  describe("order number generator", () => {
    test.skip("returns 201 for POST", () => {
      return request(app)
        .post("/order")
        .then((response) => {
    ...
    test.skip('returns random "order number" for POST', () => {
      return request(app)
        .post("/order")
        .then((response) => {
